...
public class ReminderHistoryFragment_ViewBinding implements Unbinder {
  private ReminderHistoryFragment target;

  private View view2131296303;

  @UiThread
  public ReminderHistoryFragment_ViewBinding(final ReminderHistoryFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ReminderHistoryFragment target = this.target;
