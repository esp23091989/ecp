...
public final class LoginActivity_MembersInjector implements MembersInjector<LoginActivity> {
  ...
  public static MembersInjector<LoginActivity> create(
    ...
    return new LoginActivity_MembersInjector(
        navigatorProvider, dialogsHelperProvider, preferencesUtilsProvider, presenterProvider);
  }
  ...
  public static void injectPresenter(
      LoginActivity instance, Provider<LoginPresenter_> presenterProvider) {
    instance.presenter = presenterProvider.get();
  }
}
