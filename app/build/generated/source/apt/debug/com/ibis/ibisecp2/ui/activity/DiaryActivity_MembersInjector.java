...
public final class DiaryActivity_MembersInjector implements MembersInjector<DiaryActivity> {
  ...
  public DiaryActivity_MembersInjector(
  ...
  public static MembersInjector<DiaryActivity> create(
      Provider<Navigator> navigatorProvider,
      Provider<DialogsHelper> dialogsHelperProvider,
      Provider<SharedPreferencesUtils> preferencesUtilsProvider) {
    return new DiaryActivity_MembersInjector(
        navigatorProvider, dialogsHelperProvider, preferencesUtilsProvider);
  }

  @Override
  public void injectMembers(DiaryActivity instance) {
    if (instance == null) {
  ...
  public static void injectNavigator(
      DiaryActivity instance, Provider<Navigator> navigatorProvider) {
    instance.navigator = navigatorProvider.get();
  }

  public static void injectDialogsHelper(
      DiaryActivity instance, Provider<DialogsHelper> dialogsHelperProvider) {
    instance.dialogsHelper = dialogsHelperProvider.get();
  }

  public static void injectPreferencesUtils(
      DiaryActivity instance, Provider<SharedPreferencesUtils> preferencesUtilsProvider) {
    instance.preferencesUtils = preferencesUtilsProvider.get();
  }
}
