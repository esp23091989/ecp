...
public class DiaryActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public DiaryActivity_ViewBinding(DiaryActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public DiaryActivity_ViewBinding(DiaryActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    DiaryActivity target = this.target;
